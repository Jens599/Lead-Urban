...
const InfoCard = ({ icon, title, body, last }: Props) => {
  return (
    ...
    >
      <div className="w-min-96 xl:h-54 m-2 grid w-[40] grid-cols-3 grid-rows-3 rounded-2xl bg-primary-light-blue p-3 pb-10 text-white shadow-2xl shadow-black lg:h-60">
